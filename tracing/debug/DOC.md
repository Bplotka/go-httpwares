...
* [func WithFilterFunc(f FilterFunc) opt](#WithFilterFunc)
* [func WithIsStatusCodeAnError(f IsStatusCodeAnErrorFunc) opt](#WithIsStatusCodeAnError)
...
## <a name="Middleware">func</a> [Middleware](./middleware.go#L25)
``` go
...
## <a name="Tripperware">func</a> [Tripperware](./tripperware.go#L30)
``` go
